    ...
    return (
        <div className="flex flex-row items-center gap-3 mt-3">
            ...
            <button
                ...
                className="like-button transition-transform duration-200 active:scale-95 focus:outline-none"
                ...
                <svg
                    className={`h-7 w-7 cursor-pointer
                        ${liked 
                            ...
                            : 'text-gray-500 hover:text-red-400 cursor-pointer active:scale-95'
                        }`
                    }
