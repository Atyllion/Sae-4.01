...
const ProfileHeader: React.FC<ProfileHeaderProps> = ({
    ...
    return (
        <div className='flex flex-col gap-4 p-4 sm:p-6 bg-white rounded-lg shadow-md items-start'>

            {/* Nom du profil + bouton d'abonnement */}
            <div className='flex flex-col items-start gap-2 justify-between md:flex-row md:w-full md:items-center'>
