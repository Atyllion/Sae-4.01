...
class ReplyController extends AbstractController
{
    ...
    #[Route('/api/posts/{id}/replies', name: 'reply.index', methods: ['GET'])]
    ...
    // récupérer le nombre de réponses d'un post
    #[Route('/api/posts/{id}/replies/count', name: 'reply.count', methods: ['GET'])]
    public function count(
        ...
        $totalReplies = $replyRepository->count(['post' => $post]);
    ...
    #[Route('/api/posts/{id}/reply', name: 'reply.create', methods: ['POST'])]
    ...
    #[Route('/api/replies/{id}', name: 'reply.delete', methods: ['DELETE'])]
    ...
    #[Route('/api/replies/{id}/like', name: 'reply.like', methods: ['POST'])]
    ...
    #[Route('/api/replies/{id}/likes', name: 'reply.get_likes', methods: ['GET'])]
